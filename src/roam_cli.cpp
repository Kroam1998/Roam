...
{
    if constexpr (true) // TODO : bazel genrule auto gen commit/compile info.
    {
        fmt::println("Roam version: {}{}{}", BOLD, Global::Version, RESET);
    }else {
        fmt::println("Roam version: {}{}+{}", BOLD, Global::Version, RESET);
    }
}
static void build_info() noexcept {
	fmt::println("Compiled with: TODO (TODO)");
	fmt::println("Configured with: TODO");
}
